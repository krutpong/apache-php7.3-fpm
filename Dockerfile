...
RUN apt-get install -y php7.3-apcu
RUN apt-get install -y php7.3-memcached
RUN apt-get install -y php7.3-redis
RUN apt-get install -y php7.3-gd
RUN apt-get install -y php7.3-mongodb
RUN apt-get install -y php7.3-mbstring
RUN apt-get install -y imagemagick
RUN apt-get install -y php7.3-imagick
...
RUN phpenmod mcrypt
RUN echo "extension=/usr/lib/php/20180731/mcrypt.so" > /etc/php/7.3/cli/conf.d/mcrypt.ini
RUN echo "extension=/usr/lib/php/20180731/mcrypt.so" > /etc/php/7.3/fpm/conf.d/mcrypt.ini
